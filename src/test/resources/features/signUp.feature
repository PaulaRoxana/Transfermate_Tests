 Feature: Sign Up - new user registration
  ...
  Scenario Outline: (TC_9_1) Successful account registration, user is navigated to Email And Mobile Number Verification Page
  ...
  Scenario Outline: (TC_9.2) (Verify) user cannot proceed on Email And Mobile Number Verification Page
  ...
  Scenario Outline: (TC_9.3) (Verify) user cannot proceed on Email And Mobile Number Verification Page by utilizing
  ...
  Scenario Outline: (TC_9_4) (Verify) user cannot proceed on Email And Mobile Number Verification Page
...
#    And user clicks on Open my free account button
  ...
  Scenario Outline: (TC_9_5) (Verify) user can proceed on Email And Mobile Number Verification Page
